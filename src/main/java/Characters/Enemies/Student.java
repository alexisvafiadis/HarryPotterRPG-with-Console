...
public class Student extends EnemyWizard {
    ...
    public Student(Game game, String name, double maxHP, double vulnerabilityToMagic, double spellDamageMultiplier, double defaultMasteryScoreMultiplier, String battleStartMessage) {
